...
% Build Gaussian mask for amplitude calibration (reveal the features near
% the edge of the FOV better)
x0 = 26; y0 = 20; % Central of the mask
wx0 = 22; wy0 = 22; % Width
rho = 0;
...
while 1 % Run until the image is good enough
    out_step = out_step+1;
    ...
    for zone_id = 1:n_zone
        ...
        % 4.1.3.4. Stitch the zone into the big FOV
        I_zone = abs(psi_zone).^2;
        [I_total] = stitch(I_total,I_zone,x_center,y_center,x,y,d_stitch);

        % 4.1.3.5. Update the phase of the zone
